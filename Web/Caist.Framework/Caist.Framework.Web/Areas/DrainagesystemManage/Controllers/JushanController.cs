...
namespace Caist.Framework.Web.Areas.PSDemo.Controllers
{
    ...
    public class JushanController : Controller
    {
        ...
        public JushanController(IHostingEnvironment hostingEnvironment)
        {
        ...
        {
            //
            JushanMonitorParam tfj = new JushanMonitorParam();
            //100天以前数据
            tfj.StartDate = DateTime.Now.AddDays(-100);
            tfj.EndDate = DateTime.Now;
            var dataFromDb = jushanMonitorBLL.GetSecurityInfoList(tfj);
            //
