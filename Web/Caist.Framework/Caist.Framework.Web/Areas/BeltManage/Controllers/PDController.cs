...
namespace Caist.Framework.Web.Areas.PDDemo.Controllers
{
    ...
    public class PDController : Controller
    {
        ...
        public PDController(IHostingEnvironment hostingEnvironment)
        {
        ...
        {
            //
            PidaiMonitorParam tfj = new PidaiMonitorParam();
            //100天以前数据
            tfj.StartDate = DateTime.Now.AddDays(-100);
            tfj.EndDate = DateTime.Now;
            var dataFromDb = pidaiMonitorBLL.GetSecurityInfoList(tfj);
            //
