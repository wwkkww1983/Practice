...
using Caist.Framework.CodeGenerator.Model;
...
namespace Caist.Framework.CodeGenerator.Template
{
    public class SingleTableTemplate
    {
        ...
        public BaseConfigModel GetBaseConfig(string path, string userName, string tableName, string tableDescription, List<string> tableFieldList)
        {
            ...
            baseConfigModel.OutputConfig.OutputEntity = string.Format("{0}\\Caist.Framework.Entity", path);
            baseConfigModel.OutputConfig.OutputBusiness = string.Format("{0}\\Caist.Framework.Business", path);
            baseConfigModel.OutputConfig.OutputWeb = string.Format("{0}\\Caist.Framework.Web\\Caist.Framework.Admin.Web", path);
        ...
        #region BuildEntity
        public string BuildEntity(BaseConfigModel baseConfigModel, System.Data.DataTable dt)
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendLine("using System;");
            sb.AppendLine("using Newtonsoft.Json;");
            sb.AppendLine("using System.ComponentModel.DataAnnotations.Schema;");
            sb.AppendLine("using Caist.Framework.Util;");
            sb.AppendLine();

            sb.AppendLine("namespace Caist.Framework.Entity." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildEntityParam(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("namespace Caist.Framework.Model.Param." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        #region BuildService
        public string BuildService(BaseConfigModel baseConfigModel, System.Data.DataTable dt)
        {
            ...
            sb.AppendLine("using Caist.Framework.Util;");
            sb.AppendLine("using Caist.Framework.Util.Extension;");
            sb.AppendLine("using Caist.Framework.Util.Model;");
            sb.AppendLine("using Caist.Framework.Data;");
            sb.AppendLine("using Caist.Framework.Data.Repository;");
            sb.AppendLine("using Caist.Framework.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using Caist.Framework.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");

            sb.AppendLine();

            sb.AppendLine("namespace Caist.Framework.Service." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildBusiness(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("using Caist.Framework.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using Caist.Framework.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using Caist.Framework.Service." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine();

            sb.AppendLine("namespace Caist.Framework.Business." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildController(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("using Caist.Framework.Util;");
            sb.AppendLine("using Caist.Framework.Util.Model;");
            sb.AppendLine("using Caist.Framework.Entity;");
            sb.AppendLine("using Caist.Framework.Model;");
            sb.AppendLine("using Caist.Framework.Admin.Web.Controllers;");
            sb.AppendLine("using Caist.Framework.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using Caist.Framework.Business." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using Caist.Framework.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine();

            sb.AppendLine("namespace Caist.Framework.Admin.Web.Areas." + baseConfigModel.OutputConfig.OutputModule + ".Controllers");
            sb.AppendLine("{");
        ...
        public async Task<List<KeyValue>> CreateCode(BaseConfigModel baseConfigModel, string code)
        {
            ...
            if (!string.IsNullOrEmpty(param["CodeEntity"].ParseToString()))
            {
                ...
                string codePath = baseConfigModel.OutputConfig.OutputEntity + "\\Caist.Framework.Entity\\" + baseConfigModel.OutputConfig.OutputModule + "\\" + baseConfigModel.FileConfig.EntityName + ".cs";
            ...
            if (!param["CodeEntityParam"].IsEmpty())
            {
                ...
                string codePath = baseConfigModel.OutputConfig.OutputEntity + "\\Caist.Framework.Model\\Param\\" + baseConfigModel.OutputConfig.OutputModule + "\\" + baseConfigModel.FileConfig.EntityParamName + ".cs";
                if (!File.Exists(codePath))
                {
            ...
            if (!param["CodeService"].IsEmpty())
            {
                ...
                string codePath = baseConfigModel.OutputConfig.OutputBusiness + "\\Caist.Framework.Service\\" + baseConfigModel.OutputConfig.OutputModule + "\\" + baseConfigModel.FileConfig.ServiceName + ".cs";
                if (!File.Exists(codePath))
                {
            ...
            if (!param["CodeBusiness"].IsEmpty())
            {
                ...
                string codePath = baseConfigModel.OutputConfig.OutputBusiness + "\\Caist.Framework.Business\\" + baseConfigModel.OutputConfig.OutputModule + "\\" + baseConfigModel.FileConfig.BusinessName + ".cs";
                if (!File.Exists(codePath))
                {
        ...
        private string GetBaseEntity(System.Data.DataTable dt)
        {
