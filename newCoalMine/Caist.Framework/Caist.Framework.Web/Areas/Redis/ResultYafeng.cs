...
{
    public class ResultYafeng
    {
        /// <summary>
        /// 订阅
        /// </summary>
        public static string Subscription(Yafengji yafengji)
        {
            string val = string.Empty;
            try
            {
                var keyvlaue = GetDescriptionByName(yafengji);
        ...
        /// <returns></returns>
        /// 
        private static object GetDescriptionByName(Yafengji enumItemName)
        {
