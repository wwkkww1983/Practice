...
(function ($) {
    ...
    $.fn.tabs.defaults = {
        width: "auto", height: "auto", headerWidth: 150, tabWidth: "auto", tabHeight: 32, selected: 0, showHeader: true, plain: false, fit: false, border: true, justified: false, narrow: false, pill: false, tools: null, toolPosition: "right", tabPosition: "top", scrollIncrement: 100, scrollDuration: 400, onLoad: function (_3aa) {
...
(function ($) {
    ...
    $.fn.menu.defaults = {
        zIndex: 110000, left: 0, top: 0, alignTo: null, align: "left", minWidth: 150, itemHeight: 32, duration: 100, hideOnUnhover: true, inline: false, fit: false, noline: false, events: { mouseenter: _43a, mouseleave: _43d, mouseover: _441, mouseout: _444, click: _446 }, position: function (_477, left, top) {
            return { left: left, top: top };
        }, onShow: function () {
        }, onHide: function () {
...
(function ($) {
    function init(_493) {
        var _494 = $("<span class=\"switchbutton\">" + "<span class=\"switchbutton-inner\">" + "<span class=\"switchbutton-on\"></span>" + "<span class=\"switchbutton-handle\"></span>" + "<span class=\"switchbutton-off\"></span>" + "<input class=\"switchbutton-value\" type=\"hidden\">" + "</span>" + "</span>").insertAfter(_493);
        var t = $(_493);
    ...
    function _49f(_4a0) {
        ...
        _4a2.find(".switchbutton-value").val(opts.checked ? 1 : 0);//._propAttr("checked", opts.checked);
    ...
    function _49e(_4a6, _4a7, _4a8) {
        ...
        $(_4a6).add(_4ad).val(opts.checked ? 1 : 0);//_propAttr("checked", opts.checked);
        if (ck != opts.checked) {
    ...
    $.fn.switchbutton.defaults = {
        handleWidth: "auto", width: 60, height: 30, checked: false, disabled: false, readonly: false, reversed: false, onText: "ON", offText: "OFF", handleText: "", value: "on", onChange: function (_4c0) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.validatebox.defaults = {
        required: false, validType: null, validParams: null, delay: 200, interval: 200, missingMessage: "This field is required.", invalidMessage: null, tipPosition: "right", deltaX: 0, deltaY: 0, novalidate: false, editable: true, disabled: false, readonly: false, validateOnCreate: true, validateOnBlur: false, events: {
            ...
            email: {
                ...
                validator: function (_4fc) {
                    return /^(?:-?\d+|-?\d{1,3}(?:,\d{3})+)?(?:\.\d+)?$/.test(_4fc)
...
(function ($) {
    ...
    $.fn.passwordbox.defaults = $.extend({}, $.fn.textbox.defaults, {
        passwordChar: "%u25CF", checkInterval: 200, lastDelay: 500, revealed: false, showEye: true, inputEvents: { focus: _561, blur: _565 }, val: function (_56e) {
...
(function ($) {
    ...
    function _6c3(_6c4) {
        ...
        if (opts.pagination) {
            ...
            _6cb.pagination({
                total: 0, pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_6cc, _6cd) {
    ...
    function _6da(_6db) {
        ...
        _6e0.each(function () {
            $(this).resizable({
                handles: _6e1, edge: opts.resizeEdge, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _6dc.resizing = true;
...
(function ($) {
    ...
    function _8de(_8df) {
        ...
        $(_8df).datagrid($.extend({}, opts, {
            cls: "propertygrid", view: (opts.showGroup ? opts.groupView : opts.view), onBeforeEdit: function (_8e1, row) {
    ...
    $.extend(_8ed, {
        refreshGroupTitle: function (_923, _924) {
...
(function ($) {
    function _944(_945) {
        ...
        if (opts.pagination) {
            ...
            _951.pagination({
                pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_952, _953) {
    ...
    function _977(_99a, _99b) {
        ...
        if (pid && pid != "0") {//特殊处理"0"无上级
            return find(_99a, pid);
        } else {
            return null;
        }
    };
    ...
    var _9e9 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_9ea, _9eb, _9ec) {
                        ...
                        if (_a03 == opts.treeField) {
                            ...
                            if (this.hasCheckbox(_9fe, row)) {
                                ...
                                if (crow) {
                                    ...
                                    var prow = $.easyui.getArrayItem(_a02.checkedRows, opts.idField, row[parentField]);
                                    //+)
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        treeField: null, checkbox: false, cascadeCheck: true, onlyLeafCheck: false, lines: false, animate: false, singleSelect: true, view: _9e9, rowEvents: $.extend({}, $.fn.datagrid.defaults.rowEvents, { mouseover: _95f(true), mouseout: _95f(false), click: _961 }), loader: function (_a27, _a28, _a29) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
            $.ajax({
                type: opts.method, url: opts.url, data: _a27, dataType: "json", success: function (data) {
                    _a28(data);
                }, error: function () {
            ...
            getTr: function (_a2b, id, type, _a2c) {
                type = type || "body";
                _a2c = _a2c || 0;
...
(function ($) {
    function _a35(_a36) {
        ...
        $(_a36).datagrid($.extend({}, opts, {
            cls: "datalist" + (opts.lines ? " datalist-lines" : ""), frozenColumns: (opts.frozenColumns && opts.frozenColumns.length) ? opts.frozenColumns : (opts.checkbox ? [[{ field: "_ck", checkbox: true }]] : undefined), columns: (opts.columns && opts.columns.length) ? opts.columns : [[{
                field: opts.textField, width: "100%", formatter: function (_a37, row, _a38) {
                    return opts.textFormatter ? opts.textFormatter(_a37, row, _a38) : _a37;
                }
            }]]
        }));
    };
    var _a39 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_a3a, _a3b, _a3c) {
    ...
    $.fn.datalist.defaults = $.extend({}, $.fn.datagrid.defaults, {
        fitColumns: true, singleSelect: true, showHeader: false, checkbox: false, lines: false, valueField: "value", textField: "text", groupField: "", view: _a39, textFormatter: function (_a55, row) {
            return _a55;
...
(function ($) {
    ...
    function _a58(_a59) {
        ...
        $(_a59).addClass("combo-f").textbox($.extend({}, opts, {
            icons: _a5f, onChange: function () {
            }
        }));
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: { click: _a6a, keydown: _a6e, paste: _a6e, drop: _a6e, blur: _a71 }, panelEvents: {
...
(function ($) {
    ...
    var _af4 = 0;
    var _af5 = {
        render: function (_af6, _af7, data) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", groupPosition: "static", groupField: null, groupFormatter: function (_afa) {
            return _afa;
        }, mode: "local", method: "post", url: null, data: null, queryParams: {}, showItemIcon: false, limitToList: false, unselectedValues: [], mappingRows: [], view: _af5, keyHandler: {
            up: function (e) {
                nav(this, "prev");
                e.preventDefault();
            }, down: function (e) {
            ...
            mouseover: _ad9, mouseout: _ada, mousedown: function (e) {
                e.preventDefault();
                e.stopPropagation();
            }, click: _adb, scroll: _ade
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _afe, dataType: "json", success: function (data) {
                    _aff(data);
                }, error: function () {
...
(function ($) {
    function _b38(_b39) {
        ...
        var grid = _b3a.grid;
        $(_b39).addClass("combogrid-f").combo($.extend({}, opts, {
            onShowPanel: function () {
...
(function ($) {
    function _b7a(_b7b) {
        ...
        $(_b7b).addClass("combotreegrid-f").combo($.extend({}, opts, {
            onShowPanel: function () {
        ...
        _b7c.grid.treegrid($.extend({}, opts, {
...
(function ($) {
    function _ba1(_ba2) {
        ...
        $(_ba2).addClass("tagbox-f").combobox($.extend({}, opts, {
            cls: "tagbox", reversed: true, onChange: function (_ba4, _ba5) {
                _ba6();
    ...
    $.fn.tagbox.defaults = $.extend({}, $.fn.combobox.defaults, {
        hasDownArrow: false, multiple: true, reversed: true, selectOnNavigation: false, tipOptions: $.extend({}, $.fn.textbox.defaults.tipOptions, { showDelay: 200 }), val: function (_bd3) {
...
(function ($) {
    function _bda(_bdb) {
        ...
        $(_bdb).addClass("datebox-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                _bdd(this);
                _bde(this);
                _bdf(this);
        ...
        if (!_bdc.calendar) {
            ...
            $.extend(_bdc.calendar.calendar("options"), {
...
(function ($) {
    function _c05(_c06) {
        ...
        $(_c06).datebox("calendar").calendar({
            onSelect: function (date) {
...
(function ($) {
    ...
    function _c3c(_c3d) {
        ...
        _c3f.find("a.slider-handle").draggable({
    ...
    $.fn.slider.defaults = {
        width: "auto", height: "auto", mode: "h", reversed: false, showTip: false, disabled: false, range: false, value: 0, separator: ",", min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_c65) {
            return _c65;
        }, converter: {
            toPosition: function (_c66, size) {
                var opts = $(this).slider("options");
