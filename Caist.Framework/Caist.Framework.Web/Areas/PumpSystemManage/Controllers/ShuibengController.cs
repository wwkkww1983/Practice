...
namespace Caist.Framework.Web.Areas.PumpSystemManage.Controllers
{
    ...
    public class ShuibengController : Controller
    {
        ...
        public ShuibengController(IHostingEnvironment hostingEnvironment)
        {
        ...
        {
            //
            ShuibengMonitorParam tfj = new ShuibengMonitorParam();
            //100天以前数据
            tfj.StartDate = DateTime.Now.AddDays(-100);
            tfj.EndDate = DateTime.Now;
            var dataFromDb = shuibengMonitorBLL.GetSecurityInfoList(tfj);
            //
